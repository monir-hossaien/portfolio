            ...
            <ul
                ...
                {items.map((item, idx) => (<li
                        ...
                        <blockquote>
                            ...
                            <span>
                                <img className="w-16 h-16" src={item?.image} alt="image"/>
                            </span>
                            <span
                                className="relative z-20 font-bold text-[26px]  text-neutral-800 dark:text-gray-100">
                                {item?.name}
                            </span>
                            <div className="relative z-20 flex flex-row items-center">
                                <span
                                    className="text-sm leading-[1.6] font-normal text-neutral-500 dark:text-gray-400 py-3">
                                        {item.description}
                                </span>
                            </div>
                        </blockquote>
